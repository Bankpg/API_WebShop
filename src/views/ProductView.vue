        ...
        <v-row class="ga-5 justify-center">
            ...
            <v-col cols="9" class="rounded-lg pa-5" v-else
                ...
                <v-row class="ga-5 mt-0 mb-0 justify-center">
                    <v-card :to="`/product/${product.id}`" class="rounded-lg mt-0 mb-0" width="100%" min-width="100px"
                        ...
                        <!--TEXT-->
                        <div class="d-flex flex-column justify-end px-2"
                            style="height: 40%; background-color: rgba(0, 0, 0, 0.030); ">
                            <!--Name-->
                            <v-card-title class="pa-0">{{ product.title }}</v-card-title>
                            <p style="line-height: 10px;">{{ product.category }}</p>
                            <!--Price-->
                            <h2 class="font-weight-bold mt-3" style="line-height: 20px;">${{ product.price }}</h2>
                            <!--rating-->
